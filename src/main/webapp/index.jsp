...
<div>
    <h2>This was made with a CloudBees Clickstart</h2>
    ...
    <p>
        <code>git clone ssh://git@git.cloudbees.com/
            <script>document.write(location.hostname.split(".")[1])</script>
            /
            <script>document.write(location.hostname.split(".")[0])</script>
            .git</code>
    </p>
    <p>
